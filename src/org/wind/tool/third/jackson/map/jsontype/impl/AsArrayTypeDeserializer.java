...
/**
 * Type deserializer used with {@link As#WRAPPER_ARRAY} inclusion mechanism.
 * Simple since JSON structure used is always the same, regardless of structure
 * used for actual value: wrapping is done using a 2-element JSON Array where
 * type id is the first element, and actual object data as second element.
 * 
 * @author tatus
 */
public class AsArrayTypeDeserializer extends TypeDeserializerBase {
	...
	/**
	 * Method that handles type information wrapper, locates actual subtype
	 * deserializer to use, and calls it to do actual deserialization.
	 */
