...
/**
 * Type serializer that preferably embeds type information as an additional JSON
 * Object property, if possible (when resulting serialization would use JSON
 * Object). If this is not possible (for JSON Arrays, scalars), uses a JSON
 * Array wrapper (similar to how {@link As#WRAPPER_ARRAY} always works) as a
 * fallback.
 * 
 * @since 1.5
 * @author tatus
