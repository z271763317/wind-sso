...
import org.wind.tool.third.jackson.*;
...
import org.wind.tool.third.jackson.util.JsonParserSequence;
import org.wind.tool.third.jackson.util.TokenBuffer;

/**
 * Type deserializer used with {@link As#PROPERTY} inclusion mechanism. Uses
 * regular form (additional key/value entry before actual data) when typed
 * object is expressed as JSON Object; otherwise behaves similar to how
 * {@link As#WRAPPER_ARRAY} works. Latter is used if JSON representation is
 * polymorphic
 * 
 * @since 1.5
 * @author tatu
...
public class AsPropertyTypeDeserializer extends AsArrayTypeDeserializer {
	...
	public AsPropertyTypeDeserializer(JavaType bt, TypeIdResolver idRes, BeanProperty property, Class<?> defaultImpl,
			String typePropName) {
	...
	/**
	 * This is the trickiest thing to handle, since property we are looking for may
	 * be anywhere...
	 */
	@Override
	...
	protected Object _deserializeTypedUsingDefaultImpl(JsonParser jp, DeserializationContext ctxt, TokenBuffer tb)
		...
		// if not, an error
		throw ctxt.wrongTokenException(jp, JsonToken.FIELD_NAME, "missing property '" + _typePropertyName
	...
	public Object deserializeTypedFromAny(JsonParser jp, DeserializationContext ctxt)
			throws IOException, JsonProcessingException {
		/*
		 * [JACKSON-387]: Sometimes, however, we get an array wrapper; specifically when
		 * an array or list has been serialized with type information.
		 */
	...
	// public Object deserializeTypedFromArray(JsonParser jp, DeserializationContext
	// ctxt)
